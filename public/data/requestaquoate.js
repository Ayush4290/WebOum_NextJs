// src/data/requestaquote.js (or public/data/requestaquote.js)
export default [
  {
    title: "",
    sections: [
      {
        ...
        options: [
          ...
          { label: "System Improvement to continue development", value: "improvement" }
        ]
      },
      {
        id: "services_needed",
  ...
  },
  {
    ...
    sections: [
      {
        id: "project_scope",
        subtitle: "Project Scope: Do you want us to identify and suggest more advanced functionality options?",
        options: [
          { label: "Yes, I welcome further functionality options", value: "yes_scope" },
          { label: "No, I know exactly what functionality I want", value: "no_scope" },

...
import { FaRegHandPointUp,FaExpandArrowsAlt,FaRetweet,FaRecycle ,FaRandom   } from "react-icons/fa";

export const metadata = {
  title: "Web Hosting Services – Weboum Technology Pvt. Ltd",
  description:
      ...
      <div className="webhosting-page">
        <div className="webhosting-container">
          ...
          <div className="webhosting-text-section">
            ...
            <p>
              It’s not rocket science. If you want to get a website online, then
              you will need web hosting. There’s no way your visitors can access
              your website if there’s no web host. And, if you want your website
              to perform seamlessly, you need to choose the perfect web hosting
              for your website.
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              Book a domain for your website in easy steps with WebOum website
              hosting services. We help you get a domain online for your
              website. Right from picking preferred domain names to enjoying
              affordable annual plans, we have all your web hosting needs
              served. Get everything required to set your website online.
            </p>
          </div>
        </div>
          ...
          <div className="webhosting-container-reverse-inner">
            <div className="webhosting-text-section">
              ...
              <p>
                ...
                businesses to pick a plan that suits their needs best. Get web
                hosting from a trustworthy and reliable hosting service
                provider. With WebOum there is no looking back. We offer a
                domain with a number of free emails to make it easy for you to
                get started with your business activities.
              </p>
              <p>
                WebOum web hosting services consist of 99.9% uptime with
                dedicated technical support by experts 24*7. The domains offered
                are fully equipped with cPanel. In addition to it, a 30-day
                money-back guarantee to entrust our customers with the best.
              </p>
            </div>
        ...
        <div className="webhosting-section webhosting-center-text">
          ...
          <p>
            ...
            times to make the most of it. Need more power for your business,
            pick biz hosting to obtain maximum advantages.
          </p>
          <p>
            We provide a myriad of hosting services for businesses to obtain the
            maximum benefits. Some of the services offered are:
          </p>
        </div>
        ...
        <div className="webhosting-container">
          ...
          <div className="webhosting-text-section">
            <p>
              <b>Shared Hosting -</b> It is the cheapest type of hosting out
              there. Shared hosting is an arrangement where a number of websites
              are kept on a similar server. You will be making monthly payments
              to the hosting provider and you will share the facilities with
        ...
        <div className="webhosting-container-Apart">
          <div className="webhosting-container-Apart-inner">
            <h3>
              ...
              options that have become popular such as AWS hosting, Cloud
              Hosting, Azure Hosting, Managed web hosting and more. Let’s check
            ...
            <div className="webhosting-hosting-type">
              ...
              <p>
                ...
                “piece” of a data centre where you will run your web
                applications on their infrastructure, comprising distributed
                servers. <br />
                Hence, you won’t be renting from one location and one shared
                server only. You will get access to distributed resources. This
                helps in increasing resource availability and reducing latency
                issues. <br />
                For example, your website won’t be affected if any of the
                webservers fails to respond at the vendor’s location.
              </p>
            </div>
            <div className="webhosting-hosting-type">
              <h4>Azure Hosting</h4>
              <p>
                ...
                of its flexibility and high level of scalability. One added
                benefit is the low cost of disaster recovery protection and,
                this tool is built to work for everyone. <br />
                So no matter if you are hosting one website or tons, discover
                the benefits of Azure for yourself today.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="webhosting-container">
          ...
          <div className="webhosting-grid">
            <div className="webhosting-card">
              <FaRegHandPointUp size={25} className="icons" />
              <div>
            ...
            <div className="webhosting-card">
              <FaExpandArrowsAlt  size={25} className="icons" />
              <div>
          ...
          <div className="webhosting-grid">
            <div className="webhosting-card">
              <FaRetweet size={25} className="icons" />
              <div>
                <div className="webhosting-card-title">
                  Resources on Demand:
                </div>
            ...
            <div className="webhosting-card">
              <FaRecycle  size={25} className="icons" />
              <div>
                <div className="webhosting-card-title">
          ...
          <div className="webhosting-grid">
            <div className="webhosting-card">
              <FaRandom  size={25} className="icons" />
              <div>
                <div className="webhosting-card-title">
                  Easy Domain Name Setup:
                </div>
                <p>

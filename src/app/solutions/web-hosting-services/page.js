        ...
        <div className="container">
          <div className="text-section">
            ...
            <p>
              ...
              hosting from a trustworthy and reliable hosting service provider.
              With WebOum there is no looking back. We offer a domain with a
              number of free emails to make it easy for you to get started with
              your business activities.
            </p>

            <p>
              WebOum web hosting services consist of 99.9% uptime with dedicated
              technical support by experts 24*7. The domains offered are fully
              equipped with cPanel. In addition to it, a 30-day money-back
        ...
        <div className="container">
          ...
          <div className="hosting-type">
            ...
            <p>
              ...
              benefit is the low cost of disaster recovery protection and, this
              tool is built to work for everyone.
              <br />
              So no matter if you are hosting one website or tons, discover the
              benefits of Azure for yourself today.
            </p>
          </div>
        </div>

          ...
          <section className="qa-prevention">
            ...
            <div className="qa-prevention-image">
              <div className="qa-image-container">
                <Image
                  src="/image/QualityAssuranceServices/qa-image.jpg" // Replace with actual image path
                  alt="Mobile phone with QA icons"
                  width={320} // Matches original placeholder dimensions
                  height={640} // Matches original placeholder dimensions
                />
